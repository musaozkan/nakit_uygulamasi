    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <ScrollView showsVerticalScrollIndicator={false}>
          <Text style={styles.title}>KESE'ni İsimlendir</Text>
          <Text style={styles.subtitle}>Bu isim sadece senin içindir ve daha sonra değiştirilebilir.</Text>

          <View style={styles.inputSection}>
            <Text style={styles.label}>KESE Adı*</Text>
            <View style={styles.inputContainer}>
              ...
              <TextInput
                ...
                placeholder="Örn: Altın Birikimim"
          ...
          <View style={styles.avatarSection}>
            <Text style={styles.sectionTitle}>Bir avatar seç</Text>
